...
export function firstApiGetThreePaths(input_human_belief, input_human_rank_order, x_origin, y_origin){
  console.log('heree12345')
//  const input2 = {
//     "input1_human_belief": {
...
//  }
 ...
 return new Promise((resolve, reject) => {
      ...
      fetch('http://127.0.0.1:5000/first_api/generate_initial_path', { //local development URL
        method: 'POST',
        mode: 'cors',
        cache: 'no-cache',
        headers: {

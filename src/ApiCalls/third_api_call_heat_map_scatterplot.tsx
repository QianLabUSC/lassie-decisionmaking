...
export function thirdApiCallHeatMapScatterPLot(step_number, selected_path_index, end_x_cordinate, end_y_cordinate,selected_path_data){
    ...
    // }
       ...
       return new Promise((resolve, reject) => {
            ...
            fetch('http://127.0.0.1:5000/third_api/gather_data', { //local development URL
              method: 'POST',
              mode: 'cors',
              cache: 'no-cache',
              headers: {

...
best_locs = output.get('spatial_locs')
best_spatial = output.get('spatial_reward')

plt.scatter(best_locs, best_spatial, marker="*", s=500, label="best locations")
...
plt.plot(x, y1, color="red", label="spatial reward", linewidth=1.5)
...
plt.text(3, 7, "Best Locs: ", fontsize=18, color='g')

my_path = os.path.dirname(os.path.abspath(__file__))
plt.savefig(my_path + '.\\figs_test\\Spatial.png')
